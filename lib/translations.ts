...
export const translations: Record<Language, TranslationType> = {
  en: {
    ...
    couscousFridayLabel: 'Available only on Fridays',
    grilleCategory: 'Barbecue',
  ...
  fr: {
    ...
    couscousCategory: 'Couscous',
    couscousFridayLabel: 'Disponible uniquement le vendredi',
    grilleCategory: 'Barbecue',
    sandwichesCategory: 'Sandwiches',
  ...
  ar: {
    ...
    couscousFridayLabel: 'متوفر يوم الجمعة فقط',
    grilleCategory: 'مشاوي',
